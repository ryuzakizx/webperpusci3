...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/Bukuw.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Sistem Perpustakaan Kml - <?php echo date("Y");?></br>
       <a style="color: yellow;" href="https://www.codekop.com/" target="blank"> Referensi - Click here!!
    </div>
  </footer>
</div>
<!-- /.login-box -->
