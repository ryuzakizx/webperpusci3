...
<head>
  ...
  <link href="assets_style/image/stmikbaru.jpg" rel="icon">
...
<div class="wrapper">
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="https://www.instagram.com/10969kmal/" class="logo" target="blank">

      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>P</b>K</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Perpus Kamaludin</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="<?php echo base_url();?>login/logout"onclick="return confirm('Apakah anda yakin ingin keluar?')">Sign out</a>
          </li>
